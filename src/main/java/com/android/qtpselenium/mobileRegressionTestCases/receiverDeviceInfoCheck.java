...
@Test
public class receiverDeviceInfoCheck {
	...
	@Parameters({ "Receiver", "ReceiverUdid", "AppPackage", "AppActivity", "ReceiverPlatform" })
	...
	@Parameters({"ReceiverUdid", "AaptPath", "ApkPath"})
	@Test(retryAnalyzer = receiverDeviceInfoCheck.class)
	public void getDetails(String udid, String aaptPath, String apkPath) {
		try {
			...
			System.out.println("receiver details test passed");
	...
	public void termsAndConditionsCheck() {
		try {
			...
			System.out.println("receiver terms and conditions test passed");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
